...
In contrast to the soft model, the hard model is able to maintain a mostly constant, significantly larger timestep. This allows each rank to advance particle positions substantially between communications, effectively amortizing the cost of MPI exchanges over more useful computation. As a result, the hard model maintains a favorable computation-to-communication ratio, which explains its better scaling at moderate to high core counts.
...
\begin{figure*}[b]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/growth/huge.jpeg}
