...
\newcommand{\growthcomparisonrow}[6]{%
    #1 &
        \includegraphics[width=0.2\textwidth]{figures/growth/#1_#2/#1_#2.#3.jpeg}
    &
        \includegraphics[width=0.2\textwidth]{figures/growth/#1_#2/#1_#2.#4.jpeg}
    &
        \includegraphics[width=0.2\textwidth]{figures/growth/#1_#2/#1_#2.#5.jpeg}
    &
        \includegraphics[width=0.2\textwidth]{figures/growth/#1_#2/#1_#2.#6.jpeg}
    \\
}

\newcommand{\orientationcomparisonrow}[2]{%
    #1 &
        \includegraphics[width=0.37\textwidth]{figures/orientation_comparisons/hard_e#2_orient.jpeg}
    &   
        \includegraphics[width=0.37\textwidth]{figures/orientation_comparisons/soft_e#2_orient.jpeg}
    \\
}
...
Similar to You et al.~\cite{You2018}, we observe the formation of microdomains of aligned cells within the colony. These domains emerge from mechanical interactions and growth dynamics, creating local regions where cells share similar orientations. \autoref{fig:orientation_comparison} shows the final orientation patterns for both hard and soft collision models across varying values of the stress sensitivity parameter $\lambda$. In the hard model, distinct and spatially confined patches of aligned cells are apparent for all values of $\lambda$. In contrast, the soft model tends to produce elongated bundles of aligned cells, particularly at lower stress sensitivity.

The hard model's strict non-overlapping constraints promote more localized alignment, whereas the soft model's allowance for slight overlaps facilitates the formation of extended bundles of aligned cells, as cells growing in the center of the colony cannot separate as easily due tothe high packing fraction. For $\lambda=10^{-4}$, very few distinct patches are visible for the soft model, as most cells are being highly compressed in different bundles.  \autoref{fig:orientation_closeup} provides a close-up comparison of the orientation patterns for $\lambda=10^{-4}$, highlighting the differences in microdomain structures between the two models.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\columnwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/orientation_comparisons/orientation_hard_close.jpeg}
        \caption{Close-up of orientation patterns for the hard model.}

    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/orientation_comparisons/orientation_soft_close.jpeg}
        \caption{Close-up of orientation patterns for the soft model.}

    \end{subfigure}
    \caption{Close-up comparison of orientation patterns for $\lambda=10^{-4}$ at the outer edge of the colony. The hard model (a) maintains distinct patches of aligned cells at every location, while the soft model (b) tends to form long bundles of aligned cells, especially in the dense center of the colony.}
    \label{fig:orientation_closeup}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \begin{tabular}{r M{0.37\textwidth} M{0.37\textwidth}}
             & \caption{Hard Model} & \caption{Soft Model} \\
            \vspace{-1.0cm}                                \\
    ...
    \caption{Comparison of final orientation patterns at different stress sensitivity parameters $\lambda$. The color of each cell indicates its orientation, with similar colors representing similar angles. The hard model is able to maintain visible patches of aligned cells, whereas the soft model tends to produce long bundles of aligned cells.}
...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \caption{Growth Comparison $\lambda=10^{-4}$}
        \begin{tabular}{r M{0.2\textwidth} M{0.2\textwidth} M{0.2\textwidth} M{0.2\textwidth}}
