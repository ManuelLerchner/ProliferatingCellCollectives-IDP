...
\newcommand{\growthcomparisonrow}[6]{%
    ...
    \begin{subfigure}[b]{\subfigwidth}
        \includegraphics[width=\textwidth]{figures/comparisons_new/#1_#2_#3.jpeg}
    \end{subfigure} &
    \begin{subfigure}[b]{\subfigwidth}
        \includegraphics[width=\textwidth]{figures/comparisons_new/#1_#2_#4.jpeg}
    \end{subfigure} &
    \begin{subfigure}[b]{\subfigwidth}
        \includegraphics[width=\textwidth]{figures/comparisons_new/#1_#2_#5.jpeg}
    \end{subfigure} &
    \begin{subfigure}[b]{\subfigwidth}
        \includegraphics[width=\textwidth]{figures/comparisons_new/#1_#2_#6.jpeg}
    \end{subfigure}  \\
}
