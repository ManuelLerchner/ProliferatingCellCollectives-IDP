...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{Maximum overlap vs.\ colony radius. The hard model remains near solver tolerance $\epsilon = 10^{-3}$, whereas the soft model accumulates overlap over time, approaching full overlap at late stages. Overlap decreases radially due to reduced confinement at the colony edge.}
...
\autoref{fig:huge_colony_hard} shows a representative snapshot at the maximum simulated size of $R = 260$ with 1,301{,}116 cells. The colony exhibits clear concentric density bands and a smooth boundary, indicating that the solver, contact handling, and domain decomposition remain stable at this scale.
