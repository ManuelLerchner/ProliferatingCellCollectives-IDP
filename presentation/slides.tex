...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{figures/figures_paper/Exserohilum turcicum.png}
...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{figures/figures_paper/figures/hertzian_contact_model.png}
...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.6\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{figures/figures_paper/bbpgd_total_energy.png}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.48\textwidth}
            ...
            {\includegraphics[width=\textwidth]{figures/figures_paper/hard_e-3.0198.jpeg}}\\[0.6em]
            \small
        ...
        \begin{column}{0.48\textwidth}
            ...
            {\includegraphics[width=\textwidth]{figures/figures_paper/soft_e-3.0187.jpeg}}\\[0.6em]
            \small
...
%             \\[3pt]
%             \textbf{Hard}                                                                                    &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/hard_e-4.0192.jpeg} &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/hard_e-3.0198.jpeg} &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/hard_e-2.0199.jpeg}                                                                                          \\[3pt]

%             \textbf{Soft}                                                                                    &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/soft_e-4.0198.jpeg} &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/soft_e-3.0187.jpeg} &
%             \includegraphics[width=0.25\textwidth]{figures/figures_paper/soft_e-2.0200.jpeg}                                                                                          \\[3pt]
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\textwidth]{figures/figures_paper/density_hard.jpeg}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\textwidth]{figures/figures_paper/density_soft.jpeg}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\textwidth]{figures/figures_paper/hard_e-3_orient.jpeg}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\textwidth]{figures/figures_paper/soft_e-3_orient.jpeg}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.52\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{figures/figures_paper/combined_simulation_time_vs_dt.png}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{figures/figures_paper/domain_decomposition.jpeg}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/figures_paper/strong_scaling_runtime_hard_soft.png}
    \end{figure}
...
%             \begin{figure}
%                 \centering
%                 \includegraphics[width=\textwidth]{figures/figures_paper/huge_wall_time_vs_radius_with_fit.png}
%             \end{figure}
%         \end{column}
...
\begin{frame}
    ...
    \begin{center}
        {\includegraphics[width=0.9\textwidth]{figures/misc_extra/huge_cropped.jpeg}}\\[0.6em]
        \small
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/figures_paper/cfl_vs_runtime_and_constraints.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/figures_paper/huge_bbpgd_iterations_per_step_vs_num_particles.png}
    \end{figure}
\end{frame}
